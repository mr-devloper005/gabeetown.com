...
const inputClass = 'h-12 rounded-md border border-black/10 bg-white px-4 text-base font-bold text-current outline-none transition placeholder:text-current/35 focus:border-[#2f6df6]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#2f6df6] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
